...
class CubemapRenderer: NSObject, MTKViewDelegate {
    ...
    func buildResources() {
        ...
        // Array of 2D textures which will be used to setup the cube map texture.
        skyTextures = [MTLTexture?]()
    ...
    */
        // Set up a render pass descriptor for the render pass to render into the texture.
    ...
    func createCubemapTexture() {
        ...
        //let range = 0..<6
        commandEncoder.setFragmentTextures(skyTextures, range: range)
